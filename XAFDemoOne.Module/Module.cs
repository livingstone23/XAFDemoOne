...
namespace XAFDemoOne.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class XAFDemoOneModule : ModuleBase {
        static XAFDemoOneModule() {
...
#if DEBUG
            Database.SetInitializer(new DropCreateDatabaseIfModelChanges<XAFDemoOneDbContext>());
#endif
        }
        public XAFDemoOneModule() {
            InitializeComponent();
        }
